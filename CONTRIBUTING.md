...
Feel free to [open an issue](https://github.com/buggedcom/gibberish-detector/issues/new),
or propose a [pull request](https://github.com/buggedcom/gibberish-detector/pulls).
To prevent duplication, please look at [existing issues](https://github.com/buggedcom/gibberish-detector/issues?q=is%3Aissue) before posting a new one.
